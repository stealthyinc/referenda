...
export class DebtProgressChart extends RkComponent {
  state = {
    percents: 72,
  };
  size = 120;
  ...
  render = () => {
    return (
      <View>
        <RkText rkType='header4'>Average Student Debt</RkText>
        <View style={styles.chartContainer}>
          <Svg width={scale(this.size)} height={scale(this.size)}>
            ...
            <SvgText
              ...
              {`\$29.${this.state.percents}k`}
            </SvgText>
          </Svg>
          <View>
            <RkText rkType='header4'>7k+ Responses</RkText>
            <RkText rkType='secondary2'>473 / day average</RkText>
          </View>
        </View>
      </View>
    );
